...
import com.javamalls.platform.domain.query.CombinLogQueryObject;
import com.javamalls.platform.domain.query.GoodsQueryObject;
import com.javamalls.platform.service.ICombinLogService;
...
/**组合销售管理
 *                       
 * @Filename: CombinSellerAction.java
 * @Version: 2.7.0
 * @Author: 范光洲
...
public class CombinSellerAction {
    ...
    public ModelAndView combin(HttpServletRequest request, HttpServletResponse response,
                               String currentPage, String orderBy, String orderType) {
        ModelAndView mv = new JModelAndView("user/default/usercenter/combin.html",
    ...
    public ModelAndView combin_log(HttpServletRequest request, HttpServletResponse response,
                                   String currentPage, String orderBy, String orderType) {
    ...
    public ModelAndView combin_apply(HttpServletRequest request, HttpServletResponse response,
                                     String id) {
    ...
    public ModelAndView combin_edit(HttpServletRequest request, HttpServletResponse response,
                                    String id) {
        ModelAndView mv = new JModelAndView("user/default/usercenter/combin_apply.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
    ...
    public ModelAndView combin_save(HttpServletRequest request, HttpServletResponse response,
                                    String currentPage, String orderBy, String orderType,
                                    String combin_session, String combin_begin_time,
        ...
        ModelAndView mv = new JModelAndView("success.html", this.configService.getSysConfig(),
            this.userConfigService.getUserConfig(), 1, request, response);
        String combin_session1 = CommUtil.null2String(request.getSession(false).getAttribute(
            "combin_session"));
        ...
        mv.addObject("url", CommUtil.getURL(request) + "/seller/combin.htm?currentPage="
                            + currentPage);
        return mv;
    }
    ...
    public ModelAndView combin_goods(HttpServletRequest request, HttpServletResponse response,
        ...
        if (CommUtil.null2String(goods_type).equals("main")) {
            mv = new JModelAndView("user/default/usercenter/combin_main_goods.html",
