...
import com.javamalls.platform.domain.query.ReportTypeQueryObject;
...
public class ReportTypeManageAction {
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response,
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/admin/reporttype_list.htm", "", params, pList,
            mv);
        return mv;
    }
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if ((id != null) && (!id.equals(""))) {
            ReportType reporttype = this.reporttypeService.getObjById(Long.valueOf(Long
                .parseLong(id)));
