...
public class OrderManageAction {
    ...
    public ModelAndView set_order_confirm_save(HttpServletRequest request,
                                               ...
                                               String auto_order_confirm, String auto_order_notice,
                                               String auto_order_return, String auto_order_evaluate) {
    ...
    public ModelAndView order_list(HttpServletRequest request, HttpServletResponse response,
                                   String order_status, String type, String type_data,
                                   String payment, String beginTime, String endTime,
        ...
        if (!CommUtil.null2String(endTime).equals("")) {
            ...
            ofqo.addQuery("obj.createtime", new SysMap("endTime", CommUtil.formatMaxDate(endTimestr)),
                "<=");
        }
    ...
    public ModelAndView order_view(HttpServletRequest request, HttpServletResponse response,
        ...
        //remove query_ship_getData by ttt
        TransInfo transInfo = null;//query_ship_getData(id);
