...
import com.javamalls.platform.domain.query.SpareGoodsClassQueryObject;
import com.javamalls.platform.domain.query.SpareGoodsFloorQueryObject;
...
public class SpareGoodsFloorManageAction {
    ...
    public ModelAndView floor_list(HttpServletRequest request, HttpServletResponse response,
                                   String currentPage, String orderBy, String orderType) {
        ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_list.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        SpareGoodsFloorQueryObject qo = new SpareGoodsFloorQueryObject(currentPage, mv, orderBy,
            orderType);
    ...
    public ModelAndView floor_add(HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_add.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        List<SpareGoodsClass> sgcs = this.sparegoodsclassService.query(
            "select obj from SpareGoodsClass obj where obj.parent.id is null", null, -1, -1);
        ...
        List<AdvertPosition> advertposition = this.advertPositionService
            .query(
                "select obj from AdvertPosition obj where obj.ap_width=:width and obj.ap_height=:height and obj.ap_type=:ap_type order by createtime asc",
                params, -1, -1);
    ...
    public ModelAndView floor_edit(HttpServletRequest request, HttpServletResponse response,
                                   String id, String currentPage) {
        ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_add.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        if ((id != null) && (!id.equals(""))) {
            SpareGoodsFloor sparegoodsfloor = this.sparegoodsfloorService.getObjById(Long
    ...
    public ModelAndView floor_save(HttpServletRequest request, HttpServletResponse response,
                                   String id, String currentPage, String cmd, String list_url,
                                   String add_url, String cid, String advert_url, String ap_id,
                                   String advert_type) {
        WebForm wf = new WebForm();
        SpareGoodsFloor sparegoodsfloor = null;
        if (id.equals("")) {
            sparegoodsfloor = (SpareGoodsFloor) wf.toPo(request, SpareGoodsFloor.class);
            sparegoodsfloor.setCreatetime(new Date());
        } else {
            SpareGoodsFloor obj = this.sparegoodsfloorService.getObjById(Long.valueOf(Long
                .parseLong(id)));
        ...
        try {
            map = CommUtil
                .saveFileToServer(request, "advert_img", saveFilePathName, fileName, null);
            ...
            if (fileName.equals("")) {
                if (map.get("fileName") != "") {
                    ...
                    advert_img.setCreatetime(new Date());
    ...
    public void floor_ajax(HttpServletRequest request, HttpServletResponse response, String id,
    ...
    public String floor_delete(HttpServletRequest request, HttpServletResponse response,
    ...
    public ModelAndView floor_setclass(HttpServletRequest request, HttpServletResponse response,
                                       String currentPage, String orderBy, String orderType,
                                       String fid) {
        ModelAndView mv = new JModelAndView("admin/blue/sparegoodsfloor_setclass.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        SpareGoodsClassQueryObject qo = new SpareGoodsClassQueryObject(currentPage, mv, orderBy,
            orderType);
        SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil.null2Long(fid));
        Set<Long> ids = getSpareGoodsClassChildIds(sgf.getSgc());
        Map map = new HashMap();
        map.put("ids", ids);
    ...
    public void floor_class_ajax(HttpServletRequest request, HttpServletResponse response,
                                 String id, String fieldName, String value)
                                                                           throws ClassNotFoundException {
        SpareGoodsClass obj = this.sparegoodsclassService.getObjById(Long.valueOf(Long
            .parseLong(id)));
    ...
    public String floor_setclass_switch(HttpServletRequest request, HttpServletResponse response,
                                        String currentPage, String fid, String mulitId, String type) {
        String[] ids = mulitId.split(",");
        for (String id : ids) {
            if ((id != null) && (!id.equals(""))) {
    ...
    public ModelAndView floor_setgoods(HttpServletRequest request, HttpServletResponse response,
                                       String currentPage, String orderBy, String orderType,
                                       String fid) {
    ...
    public String floor_setgoods_switch(HttpServletRequest request, HttpServletResponse response,
                                        String currentPage, String mulitId, String fid, String type) {
        String[] ids = mulitId.split(",");
        for (String id : ids) {
            if ((id != null) && (!id.equals(""))) {
