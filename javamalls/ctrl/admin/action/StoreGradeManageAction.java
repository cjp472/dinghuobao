...
import com.javamalls.platform.domain.query.StoreGradeQueryObject;
...
public class StoreGradeManageAction {
    ...
    public ModelAndView storegrade_list(HttpServletRequest request, HttpServletResponse response,
        ...
        if (null != q_gradeName && !"".equals(q_gradeName))
        ...
        mv.addObject("gradeName", q_gradeName);
        return mv;
    }
    ...
    public ModelAndView storegrade_edit(HttpServletRequest request, HttpServletResponse response,
                                        String id, String currentPage) {
        ModelAndView mv = new JModelAndView("admin/blue/storegrade_add.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        if ((id != null) && (!id.equals(""))) {
            StoreGrade storegrade = this.storegradeService.getObjById(Long.valueOf(Long
                .parseLong(id)));
    ...
    public ModelAndView storegrade_save(HttpServletRequest request, HttpServletResponse response,
        ...
        if (id.equals("")) {
            ...
            storegrade.setCreatetime(new Date());
        } else {
    ...
    public ModelAndView storegrade_template(HttpServletRequest request,
        ...
        ModelAndView mv = new JModelAndView("admin/blue/storegrade_template.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
    ...
    public ModelAndView storegrade_template_save(HttpServletRequest request,
                                                 HttpServletResponse response, String list_url,
