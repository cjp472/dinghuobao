...
import com.javamalls.ctrl.admin.tools.GoodsFloorTools;
...
import com.javamalls.platform.domain.query.GoodsFloorQueryObject;
...
/**楼层管理
 *                       
 * @Filename: GoodsFloorManageAction.java
 * @Version: 1.0
 * @Author: 范光洲
...
public class GoodsFloorManageAction {
    ...
    public ModelAndView goods_floor_list(HttpServletRequest request, HttpServletResponse response,
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/admin/goods_floor_list.htm", "", params, pList,
            mv);
        return mv;
    }
    ...
    public ModelAndView goods_floor_edit(HttpServletRequest request, HttpServletResponse response,
                                         String id, String currentPage) {
        ModelAndView mv = new JModelAndView("admin/blue/goods_floor_add.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        if ((id != null) && (!id.equals(""))) {
            GoodsFloor goodsfloor = this.goodsfloorService.getObjById(Long.valueOf(Long
                .parseLong(id)));
            Map<String, Object> params = new HashMap<String, Object>();
            params.put("gf_level", Integer.valueOf(0));
            List<GoodsFloor> gfs = this.goodsfloorService.query(
    ...
    public ModelAndView goods_floor_save(HttpServletRequest request, HttpServletResponse response,
                                         String id, String currentPage, String pid,
                                         String list_url, String add_url) {
        WebForm wf = new WebForm();
        GoodsFloor goodsfloor = null;
        if (id.equals("")) {
            goodsfloor = (GoodsFloor) wf.toPo(request, GoodsFloor.class);
            goodsfloor.setCreatetime(new Date());
        } else {
    ...
    public String goods_floor_del(HttpServletRequest request, HttpServletResponse response,
    ...
    public void goods_floor_ajax(HttpServletRequest request, HttpServletResponse response,
    ...
    public String goods_floor_class_save(HttpServletRequest request, HttpServletResponse response,
                                         String id, String ids, String gf_name) {
        GoodsFloor obj = this.goodsfloorService.getObjById(CommUtil.null2Long(id));
    ...
    public String goods_floor_gc_goods_save(HttpServletRequest request,
                                            HttpServletResponse response, String gf_name,
    ...
    public String goods_floor_list_goods_save(HttpServletRequest request,
                                              HttpServletResponse response, String list_title,
                                              String id, String ids) {
        GoodsFloor obj = this.goodsfloorService.getObjById(CommUtil.null2Long(id));
        String[] id_list = ids.split(",");
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public ModelAndView goods_floor_left_adv(HttpServletRequest request,
        ...
        List<AdvertPosition> aps = this.advertPositionService
            .query(
                "select obj from AdvertPosition obj where obj.ap_status=:ap_status and obj.ap_width=:ap_width and obj.ap_type=:ap_type order by obj.createtime desc",
                params, -1, -1);
    ...
    public ModelAndView goods_floor_right_adv(HttpServletRequest request,
        ...
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("ap_status", Integer.valueOf(1));
        params.put("ap_width", Integer.valueOf(188));
        params.put("ap_type", "img");
        List<AdvertPosition> aps = this.advertPositionService.query(
            "select obj from AdvertPosition obj where "
                    + "obj.ap_status=:ap_status and obj.ap_width=:ap_width "
                    + "and obj.ap_type=:ap_type order by obj.createtime desc", params, -1, -1);
        mv.addObject("aps", aps);
        mv.addObject("obj", obj);
        mv.addObject("gf_tools", this.gf_tools);
        return mv;
    ...
    public ModelAndView goods_floor_brand(HttpServletRequest request, HttpServletResponse response,
        ...
        CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request)
                                            + "/admin/goods_floor_brand_load.htm", "", "", pList,
            mv);
        mv.addObject("obj", obj);
        mv.addObject("gf_tools", this.gf_tools);
        return mv;
    ...
    public String goods_floor_brand_save(HttpServletRequest request, HttpServletResponse response,
                                         String id, String ids) {
        GoodsFloor obj = this.goodsfloorService.getObjById(CommUtil.null2Long(id));
        String[] id_list = ids.split(",");
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public ModelAndView goods_floor_list_goods_load(HttpServletRequest request,
        ...
        ModelAndView mv = new JModelAndView("admin/blue/goods_floor_list_goods_load.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        GoodsQueryObject qo = new GoodsQueryObject(currentPage, mv, "createtime", "desc");
        if (!CommUtil.null2String(gc_id).equals("")) {
            Set<Long> ids = genericIds(this.goodsClassService.getObjById(CommUtil.null2Long(gc_id)));
        ...
        CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request)
                                            + "/admin/goods_floor_list_goods_load.htm", "",
