...
public class IntegralGoodsManageAction {
    ...
    public ModelAndView integral_goods(HttpServletRequest request, HttpServletResponse response,
        ...
        if (this.configService.getSysConfig().isIntegralStore()) {
            IntegralGoodsQueryObject qo = new IntegralGoodsQueryObject(currentPage, mv, orderBy,
                orderType);
            if (!CommUtil.null2String(ig_goods_name).equals("")) {
                qo.addQuery("obj.ig_goods_name",
                    new SysMap("ig_goods_name", "%" + ig_goods_name.trim() + "%"), "like");
            }
            if (!CommUtil.null2String(ig_show).equals("")) {
                qo.addQuery("obj.ig_show",
                    new SysMap("ig_show", Boolean.valueOf(CommUtil.null2Boolean(ig_show))), "=");
            }
    ...
    public ModelAndView integral_goods_edit(HttpServletRequest request,
        ...
        if (this.configService.getSysConfig().isIntegralStore()) {
            if ((id != null) && (!id.equals(""))) {
                IntegralGoods integralgoods = this.integralgoodsService.getObjById(Long
    ...
    public ModelAndView integral_goods_save(HttpServletRequest request,
                                            HttpServletResponse response, String id,
                                            String currentPage, String begin_hour, String end_hour,
        ...
        if (this.configService.getSysConfig().isIntegralStore()) {
            ...
            if (id.equals("")) {
                ...
                IntegralGoods obj = this.integralgoodsService.getObjById(Long.valueOf(Long
                    .parseLong(id)));
            ...
            String ext = goods.getIg_goods_img().getExt().indexOf(".") < 0 ? "."
                                                                             + goods
                                                                                 .getIg_goods_img()
                                                                                 .getExt() : goods
                .getIg_goods_img().getExt();
            String source = request.getSession().getServletContext().getRealPath("/")
                            + goods.getIg_goods_img().getPath() + File.separator
    ...
    public String integral_goods_del(HttpServletRequest request, HttpServletResponse response,
        ...
        return "redirect:/admin/integral_goods.htm?currentPage=" + currentPage;
    }
    ...
    public ModelAndView integral_order(HttpServletRequest request, HttpServletResponse response,
                                       String currentPage, String orderBy, String orderType,
                                       String igo_order_sn, String userName, String igo_payment,
                                       String igo_status) {
        ...
        if (this.configService.getSysConfig().isIntegralStore()) {
            ...
            if (!CommUtil.null2String(igo_order_sn).equals("")) {
                qo.addQuery("obj.igo_order_sn",
                    new SysMap("igo_order_sn", "%" + igo_order_sn.trim() + "%"), "like");
            }
            ...
            if (!CommUtil.null2String(igo_status).equals("")) {
                qo.addQuery("obj.igo_status",
                    new SysMap("igo_status", Integer.valueOf(CommUtil.null2Int(igo_status))), "=");
            }
    ...
    public String integral_order_fee_save(HttpServletRequest request, HttpServletResponse response,
                                          String id, String currentPage, String igo_trans_fee) {
        IntegralGoodsOrder obj = this.integralGoodsOrderService.getObjById(CommUtil.null2Long(id));
        if (this.configService.getSysConfig().isIntegralStore()) {
    ...
    public String integral_order_ship_save(HttpServletRequest request,
                                           HttpServletResponse response, String id,
                                           String currentPage, String igo_ship_code,
                                           String igo_ship_time, String igo_ship_content) {
        IntegralGoodsOrder obj = this.integralGoodsOrderService.getObjById(CommUtil.null2Long(id));
        if (this.configService.getSysConfig().isIntegralStore()) {
