...
import com.javamalls.platform.domain.query.StoreClassQueryObject;
...
public class StoreClassManageAction {
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response,
        ...
        CommUtil.saveIPageList2ModelAndView(url + "/admin/storeclass_list.htm", "", params, pList,
            mv);
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if ((id != null) && (!id.equals(""))) {
            StoreClass storeclass = this.storeclassService.getObjById(Long.valueOf(Long
                .parseLong(id)));
    ...
    public String delete(HttpServletRequest request, String mulitId, String currentPage) {
        ...
        try {
            ...
            for (String id : ids) {
                if (!id.equals("")) {
                    Set<Long> list = genericIds(this.storeclassService.getObjById(Long.valueOf(Long
                        .parseLong(id))));
        ...
        return "redirect:storeclass_list.htm?currentPage=" + currentPage + "&msg=" + msg;
    }
    ...
    public void storeclass_verify(HttpServletRequest request, HttpServletResponse response,
    ...
    public ModelAndView storeclass_data(HttpServletRequest request, HttpServletResponse response,
        ...
        List<StoreClass> gcs = this.storeclassService.query(
            "select obj from StoreClass obj where obj.parent.id =:pid", map, -1, -1);
