...
import com.javamalls.platform.domain.query.GroupPriceRangeQueryObject;
...
public class GroupPriceRangeManageAction {
    ...
    public ModelAndView list(HttpServletRequest request, HttpServletResponse response,
        ...
        String params = "";
        GroupPriceRangeQueryObject qo = new GroupPriceRangeQueryObject(currentPage, mv, orderBy,
            orderType);

        IPageList pList = this.grouppricerangeService.list(qo);
        CommUtil.saveIPageList2ModelAndView(url + "/admin/group_range_list.htm", "", params, pList,
            mv);
        return mv;
    }
    ...
    public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if ((id != null) && (!id.equals(""))) {
            GroupPriceRange grouppricerange = this.grouppricerangeService.getObjById(Long
    ...
    public ModelAndView save(HttpServletRequest request, HttpServletResponse response, String id,
        ...
        if (id.equals("")) {
            ...
            grouppricerange.setCreatetime(new Date());
        } else {
            GroupPriceRange obj = this.grouppricerangeService.getObjById(Long.valueOf(Long
                .parseLong(id)));
        ...
        mv.addObject("add_url", CommUtil.getURL(request) + "/admin/group_price_add.htm"
