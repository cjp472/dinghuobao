...
/**金币管理
 *                       
 * @Filename: GoldRecordManageAction.java
 * @Version: 2.7.0
 * @Author: 范光洲
...
public class GoldRecordManageAction {
    ...
    public ModelAndView gold_record(HttpServletRequest request, HttpServletResponse response,
                                    ...
                                    String beginTime, String endTime, String beginCount,
                                    String endCount) {
        ...
        if (this.configService.getSysConfig().isGold()) {
            ...
            if (!CommUtil.null2String(beginCount).equals("")) {
                qo.addQuery("obj.gold_count",
                    new SysMap("gold_count", Integer.valueOf(CommUtil.null2Int(beginCount))), ">=");
            }
            if (!CommUtil.null2String(endCount).equals("")) {
                qo.addQuery("obj.gold_count",
                    new SysMap("endCount", Integer.valueOf(CommUtil.null2Int(endCount))), "<=");
            }
    ...
    public ModelAndView gold_record_edit(HttpServletRequest request, HttpServletResponse response,
        ...
        if (this.configService.getSysConfig().isGold()) {
            if ((id != null) && (!id.equals(""))) {
                GoldRecord goldrecord = this.goldrecordService.getObjById(Long.valueOf(Long
                    .parseLong(id)));
    ...
    public ModelAndView gold_record_save(HttpServletRequest request, HttpServletResponse response,
        ...
        if (this.configService.getSysConfig().isGold()) {
            ...
            if (id.equals("")) {
                ...
                GoldRecord obj = this.goldrecordService
    ...
    public String gold_record_del(HttpServletRequest request, HttpServletResponse response,
    ...
    public ModelAndView gold_record_view(HttpServletRequest request, HttpServletResponse response,
                                         String id, String currentPage) {
