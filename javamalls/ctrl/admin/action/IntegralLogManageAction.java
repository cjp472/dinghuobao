...
import com.javamalls.platform.domain.query.IntegralLogQueryObject;
...
public class IntegralLogManageAction {
    ...
    public void verify_user_integral(HttpServletRequest request, HttpServletResponse response,
                                     String userName) {
