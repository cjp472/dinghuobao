...
public class SpareGoodsManageAction {
    ...
    public ModelAndView spare_goods(HttpServletRequest request, HttpServletResponse response,
        ...
        if ((type != null) && (!type.equals(""))) {
            qo.addQuery("obj.status",
                new SysMap("obj_status", Integer.valueOf(CommUtil.null2Int(type))), "=");
    ...
    public String sparegoods_switch(HttpServletRequest request, HttpServletResponse response,
    ...
    public String sparegoods_delete(HttpServletRequest request, HttpServletResponse response,
    ...
    public void sparegoods_ajax(HttpServletRequest request, HttpServletResponse response,
    ...
    public ModelAndView sparegoods_class_list(HttpServletRequest request,
        ...
        ModelAndView mv = new JModelAndView("admin/blue/sparegoods_class_list.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
    ...
    public ModelAndView sparegoodsclass_add(HttpServletRequest request,
        ...
        ModelAndView mv = new JModelAndView("admin/blue/sparegoods_class_add.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        List<SpareGoodsClass> sparegoodsClass = this.sparegoodsclassService.query(
    ...
    public ModelAndView sparegoods_class_edit(HttpServletRequest request,
        ...
        ModelAndView mv = new JModelAndView("admin/blue/sparegoods_class_add.html",
            ...
            response);
        if ((id != null) && (!id.equals(""))) {
            SpareGoodsClass sparegoodsclass = this.sparegoodsclassService.getObjById(Long
    ...
    public ModelAndView sparegoods_class_save(HttpServletRequest request,
        ...
        if (id.equals("")) {
            ...
            sparegoodsclass.setCreatetime(new Date());
    ...
    public String sparegoods_class_del(HttpServletRequest request, HttpServletResponse response,
                                       String mulitId, String currentPage) {
        String[] ids = mulitId.split(",");
        for (String id : ids) {
            if (!id.equals("")) {
                Set<Long> list = genericIds(this.sparegoodsclassService.getObjById(Long
                    .valueOf(Long.parseLong(id))));
    ...
    public void sparegoods_class_ajax(HttpServletRequest request, HttpServletResponse response,
                                      String id, String fieldName, String value)
                                                                                throws ClassNotFoundException {
        SpareGoodsClass obj = this.sparegoodsclassService.getObjById(Long.valueOf(Long
            .parseLong(id)));
    ...
    public ModelAndView sparegoods_class_data(HttpServletRequest request,
                                              HttpServletResponse response, String pid) {
        ModelAndView mv = new JModelAndView("admin/blue/sparegoods_class_data.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        Map map = new HashMap();
        map.put("pid", Long.valueOf(Long.parseLong(pid)));
        List<SpareGoodsClass> gcs = this.sparegoodsclassService.query(
            "select obj from SpareGoodsClass obj where obj.parent.id =:pid", map, -1, -1);
    ...
    public void sparegoods_class_verify(HttpServletRequest request, HttpServletResponse response,
        ...
        if (pid.equals("")) {
            sgcs = this.sparegoodsclassService.query(
                "select obj from SpareGoodsClass obj where obj.className=:className", params, -1,
                -1);
        } else {
