...
/**活动管理
 *                       
 * @Filename: ActivityManageAction.java
 * @Version: 1.0
 * @Author: 范光洲
...
public class ActivityManageAction {
    ...
    public ModelAndView activity_list(HttpServletRequest request, HttpServletResponse response,
                                      ...
                                      String q_ac_title, String ac_status, String beginTime,
                                      String endTime) {
        ...
        if (!CommUtil.null2String(q_ac_title).equals("")) {
            qo.addQuery("obj.ac_title", new SysMap("q_ac_title", "%" + q_ac_title.trim() + "%"),
                "like");
        }
        if (!CommUtil.null2String(ac_status).equals("")) {
            qo.addQuery("obj.ac_status",
                new SysMap("ac_status", Integer.valueOf(CommUtil.null2Int(ac_status))), "=");
        }
    ...
    public ModelAndView activity_edit(HttpServletRequest request, HttpServletResponse response,
    ...
    public ModelAndView activity_save(HttpServletRequest request, HttpServletResponse response,
        ...
        mv.addObject("add_url", CommUtil.getURL(request) + "/admin/activity_add.htm"
    ...
    public String activity_del(HttpServletRequest request, HttpServletResponse response,
    ...
    public void activity_ajax(HttpServletRequest request, HttpServletResponse response, String id,
    ...
    public ModelAndView activity_goods_list(HttpServletRequest request,
                                            ...
                                            String goods_name, String ag_status) {
        ModelAndView mv = new JModelAndView("admin/blue/activity_goods_list.html",
            this.configService.getSysConfig(), this.userConfigService.getUserConfig(), 0, request,
            response);
        ActivityGoodsQueryObject qo = new ActivityGoodsQueryObject(currentPage, mv, orderBy,
            orderType);
        ...
        if (!CommUtil.null2String(ag_status).equals("")) {
            qo.addQuery("obj.ag_status",
                new SysMap("ag_status", Integer.valueOf(CommUtil.null2Int(ag_status))), "=");
        }
        if (!CommUtil.null2String(goods_name).equals("")) {
            qo.addQuery("obj.ag_goods.goods_name", new SysMap("goods_name", "%" + goods_name.trim()
                                                                            + "goods_name"), "=");
        }
    ...
    public String activity_goods_audit(HttpServletRequest request, HttpServletResponse response,
                                       String act_id, String mulitId, String currentPage) {
        Activity act = this.activityService.getObjById(CommUtil.null2Long(act_id));
        String[] ids = mulitId.split(",");
        for (String id : ids) {
            if (!id.equals("")) {
                ActivityGoods ac = this.activityGoodsService.getObjById(Long.valueOf(Long
                    .parseLong(id)));
                ac.setAg_status(1);
    ...
    public String activity_goods_refuse(HttpServletRequest request, HttpServletResponse response,
                                        String act_id, String mulitId, String currentPage) {
        String[] ids = mulitId.split(",");
        for (String id : ids) {
            if (!id.equals("")) {
