...
public class PaymentManageAction {
    ...
    public ModelAndView payment_set(HttpServletRequest request, HttpServletResponse response,
        ...
        if (CommUtil.null2String(type).equals("admin")) {
            ...
            List<Payment> objs = this.paymentService.query(
                "select obj from Payment obj where obj.mark=:mark and obj.type=:type", params, -1,
                -1);
            Payment obj = null;
            if (objs.size() > 0) {
            ...
            if (CommUtil.null2String(obj.getName()).equals("")) {
                ...
                if (mark.trim().equals("chinabank_wap")) {
                    obj.setName("手机网银+");
                }
