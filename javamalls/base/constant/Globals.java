...
public class Globals {
    public static final String  DEFAULT_SYSTEM_TITLE       = "多用户商城系统";
    public static final boolean SSO_SIGN                   = true;
    public static final int     DEFAULT_SHOP_VERSION       = 20140710;
    public static final String  DEFAULT_SHOP_OUT_VERSION   = "V2.7.0";
    public static final String  DEFAULT_WBESITE_NAME       = "";
    ...
    public static final int     DEFAULT_IMAGE_SMALL_HEIGH  = 120;
    public static final int     DEFAULT_IMAGE_MIDDLE_WIDTH = 300;
    public static final int     DEFAULT_IMAGE_MIDDLE_HEIGH = 225;
    public static final int     DEFAULT_IMAGE_BIG_WIDTH    = 1024;
    public static final int     DEFAULT_IMAGE_BIG_HEIGH    = 768;
    public static final int     DEFAULT_COMPLAINT_TIME     = 30;
    public static final String  DEFAULT_TABLE_SUFFIX       = "jm_";
    public static final String  THIRD_ACCOUNT_LOGIN        = "jm_thid_login_";
