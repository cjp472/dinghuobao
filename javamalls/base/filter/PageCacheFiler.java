...
public class PageCacheFiler extends SimplePageFragmentCachingFilter {
    ...
    private void init() throws CacheException {
        ...
        patterns = "/head.htm,/nav.htm,/footer.htm,/insurance_list.htm,/floor.htm,/advert_invoke.htm,publicstyle.css,index.css,window.css,jquery-1.4.2.min.js,jquery.lazyload.js,jquery-ui-1.8.21.js,jquery.shop.common.js,jquery.validate.min.js,jquery.jqzoom-core.js,jquery.metadata.js,jquery.rating.pack.js";
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response,
                            FilterChain chain) throws AlreadyGzippedException,
                                              ...
                                              FilterNonReentrantException, LockTimeoutException,
                                              Exception {
        if (cacheURLs == null) {
            init();
        }
