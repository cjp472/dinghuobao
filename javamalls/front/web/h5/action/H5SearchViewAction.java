...
/**搜索
 *                       
 * @Filename: H5SearchViewAction.java
 * @Version: 1.0
 * @Author: 范光洲
 ...
 */
@Controller
public class H5SearchViewAction {
    @Autowired
    ...
    @RequestMapping({ "/mobile/search_list.htm" })
    public ModelAndView search(HttpServletRequest request, HttpServletResponse response,
                               ...
                               String area_name, String goods_view, String isrepairdeposit) {
        ModelAndView mv = new JModelAndView("h5/search_product_list.html",
    ...
    @RequestMapping({ "/mobile/search_list_ajax.htm" })
