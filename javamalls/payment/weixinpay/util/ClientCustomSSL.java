package com.javamalls.payment.weixinpay.util;
import java.io.File;
...
import com.javamalls.payment.weixin.ConfigUtil;
...
public class ClientCustomSSL {
	 public static String doRefund(String url,String data) throws Exception {  
        ...
        File certfile = ResourceUtils.getFile("classpath:cert"+ Constant.SF_FILE_SEPARATOR + ConfigUtil.CERT_PATH);
