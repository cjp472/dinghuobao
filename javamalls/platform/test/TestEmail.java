...
public class TestEmail {
    public static boolean sendEmail(String username, String password, String smtp_server,
                                    String from_mail_address, String email, String subject,
                                    String content) {
        boolean ret = true;
    ...
    public static void main(String[] args) {
        ...
        String from_mail_address = "1111@qq.com";
        String email = "1111@126.com";
        String subject = "测试邮箱11";
        String content = "这是一个测试邮件11！";
        boolean ret = sendEmail(username, password, smtp_server, from_mail_address, email, subject,
            content);
        if (ret) {
