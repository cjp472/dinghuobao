 ...
 */
;var search = (function () {
    var brandMore = function () {
        $(".find_more").toggle(
            function () {
                $(this).parents(".filter").find(".option_box").removeClass("unspread")
            }, function () {
                $(this).parents(".filter").find(".option_box").addClass("unspread")
            }
        );
    };

    var brandDel = function () {
        $("span[name='brandDel']").on("click", function() {
            window.location.href = $(this).data("src") + "&_v_=" + new Date().getTime();
        });
    };
...
$(function () {
    ...
    $(".list-container").find(".list-item").hover(function() {
        $(this).find(".part_hover").show();
    	$(this).css("border-color","#fc0d1b")
    }, function() {
